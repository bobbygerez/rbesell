...
@section('breadCrumbs')
	...
	@include('templates.template3.sub-views.bread-crumbs', [
        ...
        'mainCat' => [
            [
              'name' => $merchantSubcategories->merchantCategory->mainCategory->getOriginal('name'), 
              'url' => url('browse/'. 
                $merchantSubcategories->merchantCategory->mainCategory->name, Obfuscate::encode($merchantSubcategories->merchantCategory->mainCategory->id) )
            ],
            [
              'name' => $merchantSubcategories->merchantCategory->getOriginal('name'), 
              'url' => url('browse/'.
                $merchantSubcategories->merchantCategory->mainCategory->name. '/' .
                $merchantSubcategories->merchantCategory->name, Obfuscate::encode($merchantSubcategories->merchantCategory->id) )
            ],
            [
              'name' => $merchantSubcategories->getOriginal('name'),
              'url' => ''
